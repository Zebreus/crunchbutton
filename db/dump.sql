...
CREATE TABLE `queue` (
  ...
  `type` enum('order','notification-driver','order-confirm','order-receipt','notification-your-driver','order-pexcard-funds','notification-minutes-way','notification-driver-priority','settlement-driver','settlement-restaurant','restaurant-time','event-emit') DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  `saving_from` varchar(4096) DEFAULT NULL,
  `id_phone` int(11) unsigned DEFAULT NULL,
